  ...
  useEffect(() => {
    if (program) {
      setFormData({
        ...
        path: program.path || '',
        args: program.args || '',
        webhook_urls: program.webhook_urls || program.webhook_url ? 
          (Array.isArray(program.webhook_urls) ? program.webhook_urls : [program.webhook_url]) : 
          [''],
      })
    }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">프로그램 수정</h2>
          <button
            onClick={onClose}
